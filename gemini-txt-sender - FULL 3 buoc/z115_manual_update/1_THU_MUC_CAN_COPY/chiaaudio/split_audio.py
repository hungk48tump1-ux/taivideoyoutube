...
def _build_boundaries(total_ms: int) -> List[Tuple[int, int]]:
    """
    Tạo mốc cắt:
      - 4 phút đầu: 8 giây/đoạn
      - sau đó: 10 giây/đoạn
    ...
    while pos < phase1_end:
        end = min(pos + _PHASE1_CHUNK_MS, phase1_end, total_ms)
...
def split_audio(
    ...
    *,
    ...
    Kết quả:
      - giữ logic 4 phút đầu 8 giây, phần còn lại 10 giây
    ...
    boundaries = _build_boundaries(total_ms)
